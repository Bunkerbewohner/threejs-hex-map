        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, map_generator_1.generateRandomMap(mapSize, function (q, r, height) {
                        ...
                        var trees = !interfaces_1.isMountain(height) && !interfaces_1.isWater(height) && terrain != "desert" && util_2.varying(true, false);
                        return { q: q, r: r, height: height, terrain: terrain, trees: trees, river: null, fog: true, clouds: true };
                    })];
            });
        });
    }
