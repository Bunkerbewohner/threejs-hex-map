        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            function treeAt(q, r, terrain) {
                if (terrain == "snow")
                    ...
                    return 2;
                else if (Math.abs(r) < mapSize * 0.1)
                    return 0; // tropical
                else
                    return 1;
            }
            return __generator(this, function (_a) {
                return [2 /*return*/, map_generator_1.generateRandomMap(mapSize, function (q, r, height) {
                        ...
                        var trees = interfaces_1.isMountain(height) || interfaces_1.isWater(height) || terrain == "desert" ? undefined :
                            util_2.varying(true, false) && treeAt(q, r, terrain);
                        return { q: q, r: r, height: height, terrain: terrain, treeIndex: trees, river: null, fog: false, clouds: false };
                    })];
            });
        });
    }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        options = {
                            ...
                            treeTextures: ["1", "2", "3", "4"].map(function (nr) { return loadTexture("tree" + nr + ".png"); }),
