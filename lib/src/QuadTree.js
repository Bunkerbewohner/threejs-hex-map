define(["require", "exports", "./BoundingBox"], function (require, exports, BoundingBox_1) {
    "use strict";
    ...
    var QuadTree = (function () {
        function QuadTree(data, capacity, pos, bounds) {
            ...
            if (bounds) {
                ...
                var center = new Vector2().addVectors(min, max).multiplyScalar(0.5);
        ...
        QuadTree.prototype.mapReduce = function (f) {
            ...
            var center = new Vector2(this.bounds.center.x, this.bounds.center.y);
